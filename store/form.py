# Now we will import the User model to create user by using "from django.contrib.auth.forms"
...
class UserInfoForm(forms.ModelForm):
    ...
    date_modified = forms.DateTimeField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Date Modified'}), required=False)
    ...
    class Meta:
        model = Profile
        fields = ('user', 'phone', 'address1', 'address2', 'city', 'state', 'zipcode', 'country',)
...
class ChangePasswordForm(SetPasswordForm):
	class Meta:
		model = User
		# This is a method of defining of defininig new password and confirm password fields.
